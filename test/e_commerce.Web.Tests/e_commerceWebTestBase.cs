...
{
    public abstract class e_commerceWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static e_commerceWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(e_commerceWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<e_commerceDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<e_commerceDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<e_commerceDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<e_commerceDbContext, Task<T>> func)
        {
            T result;
